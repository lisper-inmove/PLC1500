...
class Init:
    ...
    def create_engine_dismantle_db10(self):
        ...
        f11_motor_chou_value INT COMMENT "第一段电机杻矩设定值",
        f12_motor_chou_value INT COMMENT "第一段电机杻矩设定值",
        f21_motor_chou_value INT COMMENT "第二段电机杻矩设定值",
        f22_motor_chou_value INT COMMENT "第二段电机杻矩设定值",
        f31_motor_chou_value INT COMMENT "第三段电机杻矩设定值",
        f32_motor_chou_value INT COMMENT "第三段电机杻矩设定值",
        f41_motor_chou_value INT COMMENT "第四段电机杻矩设定值",
        f42_motor_chou_value INT COMMENT "第四段电机杻矩设定值",
        station_shielding BOOLEAN COMMENT "工位屏蔽",
        status SMALLINT COMMENT "第0~2位为1时表示 运行中/报警中/急停中",
        product_exists TINYINT COMMENT "0位置1表示有产品;1位置1表示无产品",
        product_abnormal TINYINT COMMENT "0位置1表示正常产品;1位置1表示异常产品",
